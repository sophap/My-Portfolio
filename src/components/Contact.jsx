  ...
  return (
    ...
    >
      ...
      >
        ...
        <br/>
        <p className="text-secondary font-bold">Email:&nbsp; &nbsp; rightpraise@gmail.com</p>
        <br/>
        <p className="text-secondary font-bold">Whatsapp:&nbsp; &nbsp; +234 7030336824</p>
        <br/>
        ...
        <a
          onClick={() => window.open("https://twitter.com/phrai_zee", "_blank")}
          className='w-10 h-10 black-gradient rounded-full flex justify-center items-center cursor-pointer'>
          <img
            src={twitter}
            alt="twitter"
